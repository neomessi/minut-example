 ...
 * Note: the users _id field is purposely omitted - that is never exposed (or even used by app), instead a tempory "permit id" is used to get user data (which is temporary) -
